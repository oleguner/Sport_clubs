...
const Header = () => {
  return (
    <div className="shadow h-16 flex bg-skin-header-main">
      <div className="flex-auto flex justify-between items-center mx-8 ">
        <div>
        ...
        <div className="inline-flex justify-center items-center">
          <div className="px-4">
            <Menu as="div" className="relative inline-block text-left">
              {({ open }) => (
                <>
                  <div>
                    <Menu.Button className="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-300">
                      ENG
                    </Menu.Button>
                  </div>
          ...
          >
            ...
            <label
              for="toggle"
              className="text-base text-skin-base cursor-pointer"
            >
              Theme
            </label>
